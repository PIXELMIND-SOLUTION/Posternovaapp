...
import 'package:posternova/widgets/language_widget.dart'; // your LanguageProvider import
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: List.generate(5, (index) {
          DateTime date = DateTime.now().add(Duration(days: index));
          String day = DateFormat('d').format(date);
          String month = DateFormat('MMM', langCode).format(date);
          String weekday = DateFormat('E', langCode).format(date);
