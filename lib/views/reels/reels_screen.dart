...
//   /// Builds the business info bottom bar (matches SamplePosterScreen style)
...
//           // ── Gradient overlay (taller to accommodate bottom bar) ──
//           Positioned(
//             left: 0,
//             right: 0,
//             bottom: 0,
...
//           // ── Right side actions (raised above bottom bar) ──
//           Positioned(
//             right: 12,
//             // Raised enough to sit above the business info bar (~70px)
//             bottom: 145,
//             child: Column(
//               children: [
//                 // Like button
...
//           // ── Bottom left: user info + caption (above business bar) ──
//           Positioned(
//             left: 16,
//             right: 80,
//             // Push up above business info bar (~70px tall)
//             bottom: 80,
//             child: Column(
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
