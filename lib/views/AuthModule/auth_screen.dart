...
//     // Use AuthProvider instead of (or in addition to) SmsProvider
...
//     final authProvider = Provider.of<AuthProvider>(context, listen: false);
//     print(
//       "kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk$mobile",
//     );
...
//       // 👇 Auto-fill OTP from provider
//       if (_otpController != "") {
//         _otpController.text = resOtp.toString();
//       }
//     });
...
class _AuthScreenState extends State<AuthScreen> with SingleTickerProviderStateMixin {
  ...
  //     // If the response contains a user with only _id and mobile, it's a new user
  //     if (responseBody != null) {
  //       final userData = jsonDecode(responseBody);
  //       final user = userData['user'];
        
  //       // Check if user has only basic fields (new user)
  //       // Assuming new users only have _id and mobile
  ...
  //     // Existing user - authenticate and navigate to main screen
  //     final success = await authProvider.login(_pendingMobile!);
  ...
  // Replace your existing _handleVerifyOtp method in auth_screen.dart with this:
...
//             print('Greeting: ${greetResponse.data!.title}');
//             // Show greeting message
//             if (greetResponse.data!.greeting != null) {
//               _showSnackBar(greetResponse.data!.greeting!);
//             }
//           }
//         } catch (e) {
...
Future<void> _handleVerifyOtp() async {
  ...
  // }
    ...
    // Replace your existing _handleSignup method in auth_screen.dart with this:
