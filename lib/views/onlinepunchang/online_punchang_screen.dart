...
// // //   /// Formats a DateTime using the app's current language so the month name
// // //   /// appears in the correct language (e.g. "फ़रवरी" for Hindi).
...
// // //   void initState() {
// // //     super.initState();
// // //     // Pre-load locale data for every language your app supports
...
// // //     // Consumer so the whole screen rebuilds when language changes
...
// // //           // ── Date selector ──
// // //           // _formatDate() uses _langCode so the month name switches language
// // //           GestureDetector(
...
// // //                   Text(
// // //                     _formatDate(selectedDate), // ← locale-aware date
// // //                     style: const TextStyle(
// // //                       color: Colors.white,
// // //                       fontSize: 16,
...
// // //           // ── Location selector ──
// // //           // The location string itself is user-entered so it stays as typed.
// // //           // The surrounding label/hint text is already translated via _t().
// // //           GestureDetector(
...
// // //                   Flexible(
// // //                     child: Text(
// // //                       location, // user-entered value — stays as typed
// // //                       style: const TextStyle(
// // //                         color: Colors.white,
// // //                         fontSize: 14,
// // //                         fontWeight: FontWeight.w600,
...
// // //     if (panchangData == null || panchangData!['data'] == null) return _buildErrorState();
// // //     final data = panchangData!['data'];
// // //     final user = panchangData!['user'];
// // //     if (data == null || user == null) return _buildErrorState();
...
// // //     // final name = user['name']?.toString() ?? _t('user');
...
// // //       padding: const EdgeInsets.all(20),
// // //       decoration: BoxDecoration(
// // //         gradient: LinearGradient(colors: [Colors.deepOrange.shade400, Colors.orange.shade600]),
// // //         borderRadius: BorderRadius.circular(15),
// // //         boxShadow: [
...
// // //     return Row(
// // //       children: [
// // //         Expanded(child: _buildTimingCard(_t('panchang_sunrise'), _formatTime(data['sunrise']), Icons.wb_sunny, Colors.amber)),
// // //         const SizedBox(width: 10),
// // //         Expanded(child: _buildTimingCard(_t('panchang_sunset'), _formatTime(data['sunset']), Icons.nights_stay, Colors.indigo)),
// // //       ],
// // //     );
// // //   }

// // //   Widget _buildTimingCard(String title, String time, IconData icon, Color color) {
// // //     return Container(
// // //       padding: const EdgeInsets.all(15),
// // //       decoration: BoxDecoration(
// // //         color: Colors.white,
...
// // //       _t('panchang_nakshatra'), Icons.stars, Colors.purple,
// // //       Column(children: nakshatras.map((n) {
// // //         if (n == null) return const SizedBox.shrink();
// // //         return _buildListItem(
// // //           n['name']?.toString() ?? 'N/A',
// // //           '${_formatTime(n['start'])} - ${_formatTime(n['end'])}',
// // //           '${_t('panchang_lord')}: ${n['lord']?['vedic_name'] ?? 'N/A'}',
// // //         );
// // //       }).toList()),
// // //     );
// // //   }
...
// // //     return _buildSectionCard(
// // //       _t('panchang_tithi'), Icons.calendar_month, Colors.blue,
// // //       Column(children: tithis.map((t) {
// // //         if (t == null) return const SizedBox.shrink();
// // //         return _buildListItem(
// // //           t['name']?.toString() ?? 'N/A',
// // //           '${_formatTime(t['start'])} - ${_formatTime(t['end'])}',
// // //           t['paksha']?.toString() ?? 'N/A',
// // //         );
// // //       }).toList()),
// // //     );
// // //   }
...
// // //     return _buildSectionCard(
// // //       _t('panchang_yoga'), Icons.self_improvement, Colors.green,
// // //       Column(children: yogas.map((y) {
...
// // //     return _buildSectionCard(
// // //       _t('panchang_karana'), Icons.av_timer, Colors.orange,
// // //       Column(children: karanas.map((k) {
