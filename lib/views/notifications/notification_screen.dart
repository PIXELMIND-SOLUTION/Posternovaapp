...
/////////////////////////  Added the clear all notification in the appbar///////////////////
  ...
  Future<void> deleteNotification(String notificationId) async {
    try {
      ...
      print('Response status code for delete notifications ${response.statusCode}');
            print('Response bodyyyyyyyyyyy for delete notifications ${response.body}');
  ...
  Future<void> clearAllNotifications() async {
    ...
    try {
      ...
      final response = await http.delete(
        Uri.parse("$baseUrl/deletenotifications/${widget.userId}"),
        headers: {"Content-Type": "application/json"},
        body: jsonEncode({"notificationIds": allIds}),
      );

      print(
        'Response status code for delete all notifications ${response.statusCode}',
      );
      print(
        'Response bodyyyyyyyyyyyyy for delete all notifications ${response.body}',
      );
      ...
      child: Row(
        children: [
          ...
          if (_notifications.isNotEmpty)
            GestureDetector(
              onTap: _clearingAll ? null : clearAllNotifications,
              child: Container(
                height: 36,
