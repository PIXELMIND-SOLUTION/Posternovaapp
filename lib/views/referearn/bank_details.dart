...
// import 'package:posternova/views/referearn/redeem_status_screen.dart';
...
//                   MaterialPageRoute(
//                     builder: (context) => RedemptionStatusScreen(
...
//       labelText:
//           '${AppText.translate(context, label)}${isRequired ? ' *' : ' (Optional)'}',
...
//                                 ),
//                                 const SizedBox(height: 12),
//                                 ...redeemProvider.redemptionHistory.take(3).map((
//                                   redemption,
//                                 ) {
//                                   final maskedAccount =
...
class _BankDetailsScreenState extends State<BankDetailsScreen> {
  ...
  static const Color _primary = Color(0xFFF5C518);
  static const BorderRadius _radius16 = BorderRadius.all(Radius.circular(16));
              ...
              onPressed: () async {
                ...
                if (userData != null && mounted) {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) =>
                          RedemptionStatusScreen(userId: userData.user.id),
                    ),
                  );
                }
              },
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(
                        Icons.account_balance,
                        color: isDark ? _primary : Colors.black87,
                        size: 28,
                      ),
                    ),
                    const SizedBox(width: 14),
