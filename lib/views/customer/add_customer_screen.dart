...
class _AddnewCustomersState extends State<AddCustomer>
  ...
  final TextEditingController _anniversaryController = TextEditingController();
  bool _isLoading = false;
  bool _isOthersExpanded = false; // ← toggle state
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.only(left: 4, bottom: 8),
          child: Text(
            '${AppText.translate(context, 'gender')} (Optional)',
            style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w600,
              color: isDarkMode
  ...
  // ─── Collapsible "Others" Section Header ────────────────────────────────────
  Widget _buildOthersHeader(bool isDarkMode) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Gender, Festival Preference & Email',
                    style: TextStyle(
                      fontSize: 12,
                      color: isDarkMode
                          ? AddCustomerColors.darkTextHint
                          : AddCustomerColors.lightTextHint,
                    ),
                  ),
                ],
              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInputField(
                          ...
                          label: AppText.translate(context, 'email_optional'),
                          icon: Icons.email_rounded,
                          hint: AppText.translate(
                              context, 'enter_email_optional'),
                          keyboardType: TextInputType.emailAddress,
                          validator: (value) {
                            if (value != null && value.isNotEmpty) {
                              if (!RegExp(
