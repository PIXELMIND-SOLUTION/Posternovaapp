...
class _AddCustomersState extends State<CustomerScreen>
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text('Filter by Religion', style: TextStyle(color: textColor)),
          ],
        ),
        content: SingleChildScrollView(
          child: Column(
            ...
            children: _religionOptions.map((religion) {
              final isSelected =
                  _selectedReligionFilter == religion ||
                  (religion == 'All' && _selectedReligionFilter == null);
              return RadioListTile<String>(
                title: Text(religion, style: TextStyle(color: textColor)),
                value: religion,
        ...
        actions: [
          TextButton(
            ...
            child: Text('Clear Filter', style: TextStyle(color: textColor)),
          ),
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(
  ...
  void _handleAddCustomer() {
    ...
    //     message:
    //         "Add Customer is a premium feature. Unlock unlimited customer management by upgrading to a premium plan.",
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    // Religion badge
                    if (customer['religion'] != null &&
                        customer['religion'].toString().isNotEmpty)
                      Container(
      ...
      child: Center(
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.people_outline, size: 120, color: subtextColor),
